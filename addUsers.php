...
<body>
    ...
    <div class="flex mainDiv">
        ...
        <div class="mainContent">
            ...
            <div class="flex">
                <div>
                    <form class="flex columnDiv" action="au.php" method="post">
                        <p class="title noMargin">Add User</p>
                        <input class="searchInput formInput" type="text" id="user" name="user" placeholder="Username" required >
                        <input class="searchInput formInput" type="password" id="pass" name="pass" placeholder="Password" required >
                        <input class="searchInput formInput signIn" type="submit" value="Add">
                    </form>
                </div>
            ...
            <div class="console">
                    ...
                    <?php                   
                    session_start();
                    if (isset($_SESSION['auMsg'])) {
                        echo $_SESSION['auMsg'];
                        unset($_SESSION["auMsg"]);
                    } else {
                        echo"...";
                    }
                    ?>
